...
public class SStature extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null!= getIntent().getStringExtra("scanner_resultStaure")){
           ...
           // Toast.makeText(this, ""+scanner_res, Toast.LENGTH_SHORT).show();
            Log.d("scanner_resultStaure",scanner_res);

        }
        imagesStatureback= (ImageView) findViewById(R.id.imagesStatureback);
        imagesStaturebackOnclick();
        edittextStature= (EditText) findViewById(R.id.edittextStature);
        findViewById(R.id.butttonStatureSubmit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                edt_value = edittextStature.getText().toString().trim();
    ...
    public class SendRequest extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try{
                ...
                postDataParams.put("type","S");
                postDataParams.put("remark",edt_value);
        ...
        protected void onPostExecute(String result) {
           // Toast.makeText(getApplicationContext(), result, Toast.LENGTH_LONG).show();
            Log.e("params",result);
            startActivity(new Intent(SStature.this,Swise.class));
    ...
    private void imagesStaturebackOnclick() {
        imagesStatureback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
            }
